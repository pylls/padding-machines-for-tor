...
- Released three tools that are valuable for evaluating machines. One for
  computing [bandwidth
  overhead](https://github.com/pylls/padding-machines-for-tor/tree/master/evaluation/overhead.py),
  one for [visualizing
  traces](https://github.com/pylls/padding-machines-for-tor/tree/master/evaluation/visualize.py),
  and a third for
  [tweaking](https://github.com/pylls/padding-machines-for-tor/tree/master/evaluation/tweak.md)
  a pair of machines.
